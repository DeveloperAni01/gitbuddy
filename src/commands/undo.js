...
async function undoCommand() {
    try {
        ...
        if (!repo.hasCommits) {
            console.log(
                boxen(
                    ...
                    { padding: 1, borderColor: 'yellow', title: '🤖 GitBuddy Undo', titleAlignment: 'center' }
                )
            );
            return;
        }
        ...
        if (action === 'cancel') {
            messages.info('Undo cancelled. Nothing changed.', 'GitBuddy Undo');
            return;
        }
        ...
        if (action === 'soft') {
            if (commitCount === 1) {
                ...
                if (!proceed) {
                    messages.info('Undo cancelled.', 'GitBuddy Undo');
                    return;
                }
            }
            ...
            console.log(
                boxen(
                    ...
                    chalk.gray('Run gitbuddy status to see them.\n\n') +
                    chalk.gray('💡 Tip: Run gitbuddy commit to recommit with a new message!'),
                    { padding: 1, borderColor: 'green', title: '🤖 GitBuddy Undo', titleAlignment: 'center' }
                )
            );
        }
        ...
        if (action === 'mixed') {
            ...
            console.log(
                boxen(
                    ...
                    chalk.gray('Run gitbuddy status to see them.\n\n') +
                    chalk.gray('💡 Tip: Run gitbuddy commit to recommit!'),
                    { padding: 1, borderColor: 'green', title: '🤖 GitBuddy Undo', titleAlignment: 'center' }
                )
            );
        }
        ...
        if (action === 'hard') {
            ...
            if (!firstConfirm) {
                messages.info('Smart choice! Undo cancelled.', 'GitBuddy Undo');
                return;
            }
            ...
            if (!secondConfirm) {
                messages.info('Undo cancelled. Nothing deleted.', 'GitBuddy Undo');
                return;
            }
            ...
            console.log(
                boxen(
                    ...
                    chalk.gray('💡 Tip: Run gitbuddy status to confirm current state!'),
                    { padding: 1, borderColor: 'green', title: '🤖 GitBuddy Undo', titleAlignment: 'center' }
                )
            );
        }
        ...
        if (action === 'unstage') {
            ...
            if (filesToUnstage.length === 0) {
                messages.info('No files selected. Nothing changed.', 'GitBuddy Undo');
                return;
            }
        ...
        if (action === 'discard_file') {
            ...
            if (!proceed) {
                messages.info('Discard cancelled. File unchanged.', 'GitBuddy Undo');
                return;
            }
        ...
        if (action === 'discard_all') {
            ...
            if (!firstConfirm) {
                messages.info('Smart choice! Nothing discarded.', 'GitBuddy Undo');
                return;
            }
            ...
            if (!secondConfirm) {
                messages.info('Discard cancelled.', 'GitBuddy Undo');
                return;
            }
            ...
            console.log(
                boxen(
                    ...
                    chalk.gray('💡 Tip: Run gitbuddy status to confirm!'),
                    { padding: 1, borderColor: 'green', title: '🤖 GitBuddy Undo', titleAlignment: 'center' }
                )
            );
        }
        ...
        if (action === 'revert') {
            ...
            console.log(
                boxen(
                    ...
                    { padding: 1, borderColor: 'cyan', title: '🤖 GitBuddy Undo', titleAlignment: 'center' }
                )
            );
            ...
            if (!proceed) {
                messages.info('Revert cancelled.', 'GitBuddy Undo');
                return;
            }
            ...
            console.log(
                boxen(
                    ...
                    chalk.gray('💡 Tip: Run gitbuddy push to send revert to GitHub!'),
                    { padding: 1, borderColor: 'green', title: '🤖 GitBuddy Undo', titleAlignment: 'center' }
                )
            );
        }
            ...
            if (popped) {
                console.log(
                    boxen(
                        ...
                        chalk.gray('💡 Tip: Run gitbuddy status to see restored files!'),
                        { padding: 1, borderColor: 'green', title: '🤖 GitBuddy Undo', titleAlignment: 'center' }
                    )
                );
            }
